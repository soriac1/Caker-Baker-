...
function Model({ ...props }) {
  ...
  const { nodes, materials } = useGLTF('/Cake2.gltf')
  return (
    ...
    <mesh
        castShadow
        receiveShadow
        geometry={nodes.InnerBase.geometry}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.pCylinder29001.geometry}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.Candle005.geometry}
      ...
      >
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Candle003.geometry}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.topcream.geometry}
        material={materials.cream1text}
        position={[-0.07, 1.14, -0.01]}
        scale={0.12}
        visible = {props.customLeg.legs === 1}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.pCylinder29002.geometry}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.TopcreamL1.geometry}
        material={materials.creamtext}
        position={[-0.07, 1.14, -0.01]}
        scale={0.12}
        material-color={props.customColors.soul1}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.InnerBaseL1.geometry}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.InnerBaseL2.geometry}
        material={materials["Base.003"]}
        position={[0, 1.12, 0.01]}
        rotation={[1.57, 0, 0.02]}
        scale={0.75}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.TopcreamL2.geometry}
        material={materials.creaml2text}
        position={[-0.07, 1.99, -0.01]}
        scale={0.09}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.OutBase.geometry}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.OutBaseL1.geometry}
        material={materials.basetext2L1}
        position={[0, 0.68, 0]}
        scale={[0.12, 0.15, 0.12]}
        material-color={props.customColors.mesh1}
        visible = {props.customLeg.legs === 2}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.cake2baseL2.geometry}
        material={materials.basetext2L2}
        position={[0, 1.63, 0]}
